# Generated by Django 2.0.3 on 2018-04-22 07:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educportal.Theme')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='section',
            name='for_super_section',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='educportal.StudentGroupAccess'),
        ),
        migrations.AddField(
            model_name='academicgroup',
            name='group_access',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educportal.StudentGroupAccess'),
        ),
        migrations.AddField(
            model_name='user',
            name='academic_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educportal.AcademicGroup'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
